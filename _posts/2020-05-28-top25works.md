...
*<em>If you’d like to try this yourself, you can run the following query on <a href="http://data.carnegiehall.org/" target="_blank">data.carnegiehall.org</a> -- just change the year in the FILTER statement</em>:<br>
```
